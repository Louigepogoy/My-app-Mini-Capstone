      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
        ...
        <main className="grid gap-6 md:grid-cols-3">
          ...
          <section className="space-y-2 rounded-2xl border border-slate-800 bg-slate-900/80 p-4 shadow-lg">
            ...
            <p className="text-[11px] text-slate-400">
              Add admin tools here, like managing users or pricing.
            </p>
            <div className="mt-3 space-y-2 text-xs">
              <button className="inline-flex w-full items-center justify-center rounded-full bg-fuchsia-500 px-3 py-2 font-medium text-white shadow-sm hover:bg-fuchsia-400">
                Manage users
              </button>
              <button className="inline-flex w-full items-center justify-center rounded-full bg-slate-800 px-3 py-2 font-medium text-slate-50 hover:bg-slate-700">
                Adjust pricing
              </button>
              <button className="inline-flex w-full items-center justify-center rounded-full bg-slate-800 px-3 py-2 font-medium text-slate-50 hover:bg-slate-700">
                Review vehicles
